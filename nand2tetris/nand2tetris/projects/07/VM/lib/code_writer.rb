class CodeWriter
  ...
  def write_arithmetic(command)
    ...
    when "eq" then write_eq_command
    when "gt" then write_gt_command
    when "lt" then write_lt_command
  ...
  def write_eq_command
    write_comparison_command("JEQ")
  end

  def write_gt_command
    write_comparison_command("JGT")
  end

  def write_lt_command
    write_comparison_command("JLT")
  end
